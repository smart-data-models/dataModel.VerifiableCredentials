...
Link to the [example](https://smart-data-models.github.io/dataModel.VerifiableCredentials/LegalEntity/examples/example.jsonld.csv) (keyvalues) for NGSI-LD in CSV format
...
Link to the [PostgreSQL schema](https://smart-data-models.github.io/dataModel.VerifiableCredentials/LegalEntity/schema.sql) of this data model
### Contribution
